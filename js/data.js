(function () {
  ...
  const iconPaths = {
    ...
    filter:'<path d="M4 6h16M7 12h10M10 18h4"/>', whatsapp:'<path d="M20 11.5a8 8 0 0 1-11.8 7L4 20l1.5-4.1A8 8 0 1 1 20 11.5Z"/><path d="M8.6 8.2c.3 2 2.2 4.6 4.9 5.5l1.3-1.1 1.8.9c-.3 1.8-1.4 2.5-3.1 2.3-3.7-.5-7-4-7.4-7.7-.2-1.6.6-2.6 2.2-2.9l.9 1.8-.6 1.2Z"/>'
  };

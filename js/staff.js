(function () {
  ...
  function render() {
    ...
    root.innerHTML = `<main class="staff-stock-page"><header><a href="index.html"><img src="one-line-logo.webp" alt="One-Line"></a><div><h1>Staff</h1><small>${S.esc(account.name)}</small></div><button data-logout>${S.icon('logout')} Sign out</button></header><div id="stock-root"></div></main>`;

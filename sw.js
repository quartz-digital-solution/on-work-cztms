const CACHE='one-line-rebuilt-v1';
const CORE=['./','./index.html','./css/site.css','./js/store.js','./js/customizer.js','./js/customer.js','./one-line-mark.svg','./assets/whatsapp-logo-green.svg'];
